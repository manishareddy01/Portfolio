    ...
    <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{delay:0.1}} className='w-full'>
        ...
        <ul className='mt-6 flex flex-col gap-3'>
            <li className='text-base text-textDark gap-2 flex'>
                <span className='text-textGreen mt-1'><TiArrowForward/></span>Managed the company's social media accounts, creating and scheduling posts and engaging with followers, resulting in a 20% increase in social media engagement.
            </li>
            <li className='text-base text-textDark gap-2 flex'>

...
import { SlSocialYoutube, SlSocialLinkedin, SlSocialFacebook } from "react-icons/sl";
import { TbBrandGithub, TbBrandGithubFilled, TbBrandLinkedin, TbBrandThreads, TbBrandTwitterFilled } from "react-icons/tb";
...
const Navbar =()=>{
    ...
    <div className="w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4">        
        <div className="max-w-container h-full mx-auto py-1 font-micro5 flex items-center justify-between">
                <motion.div initial={{ opacity: 0}} // Initial animation values
                ...
                <div className="hidden md:inline-flex items-center gap-7">
                    <ul className="flex text-[13px] gap-7">
                        <Link onClick={handleScroll} href="#home" className="flex items-center gap-1 font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link">
                            <motion.li initial={{y:-10, opacity: 0}} // Initial animation values
                                       animate={{ y:0,opacity: 1}}      // Animation to apply
                        ...
                        <Link onClick={handleScroll} href="#projects" className="flex items-center gap-1 font-medium text-textDark hover:text-textGreen cursor-pointer duration-300 nav-link">
                        <motion.li initial={{y:-10, opacity: 0}} // Initial animation values
                                       animate={{ y:0,opacity: 1}}      // Animation to apply
              ...
              <div className="flex flex-col items-center gap-7">
                ...
                <div className="flex gap-4">
                  <motion.a
                    ...
                    href="https://github.com/manishareddy01"
                    target="_blank"
                  >
                  ...
                  <motion.a
                    ...
                    href="https://www.linkedin.com/in/manishaaddula/"
                    target="_blank"
                  >
                    <span className="w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 hover:border-textGreen text-zinc-200 rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                      <TbBrandLinkedin/>
                  ...
                  <motion.a
                    ...
                    href="https://twitter.com/manisha_says"
                    target="_blank"
                  >
                    <span className="w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 hover:border-textGreen text-zinc-200 rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                  ...
                  <motion.a
                    ...
                    href="https://www.threads.net/@manishasays"
                    target="_blank"
                  >
                    <span className="w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 hover:border-textGreen text-zinc-200 rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                      <TbBrandThreads />
              ...
              <motion.a
                ...
                href="mailto:manishaaddula@gmail.com"
              >
                <p>Send a Mail to connect!</p>
              </motion.a>
                            </motion.div>
                            </div>
                    )
